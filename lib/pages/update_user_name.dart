                          ...
                          if (userNameController.text.length > 0) {
                            if (userNameController.text == userName) {
                              ...
                              users
                                  ...
                                  .then((value) {if (terminalPrinting) print("[SYS] name updated: $userName");})
                                  .catchError((error) {if (terminalPrinting) print("[ERR] Failed to update name");})

                                  .then((value) {
                                FocusManager.instance.primaryFocus?.unfocus();
                                Navigator.pushNamed(context, '/settings');
                                Flushbar(
                                  message: "¡Nombre cambiado a $userName!",
                                  duration: Duration(seconds: 3),
